...
import React, { useState } from 'react'
 ...
 function Registerpage() {
    ...
    let[errors,setErrors]=useState<registerErrorType>({});
   ...
   async function submitForm()
    {
      ...
      try
      {
        ...
        const response=await axios.post("/api/auth/register",authState);
            ...
            <div className="space-y-5">
              <div>
                ...
                <div className="mt-2">
                  ...
                  ></input>
                  <p className=' font-bold text-red-700'>{errors?.name}</p>
                </div>
              </div>
              <div>
                ...
                <div className="mt-2">
                  ...
                  ></input>
                  <p className=' font-bold text-red-700'>{errors?.email}</p>
                </div>
              </div>
              <div>
                ...
                <div className="mt-2">
                  ...
                  ></input>
                  <p className=' font-bold text-red-700'>{errors?.password}</p>
                </div>
              </div>
              <div>
                <div className="flex items-center justify-between">
